...
--6 Find the average rating for each category ordered by the highest rated to 
--lowest rated.
SELECT CATEGORY, AVG(rating), COUNT(*) FROM analytics GROUP BY CATEGORY 
ORDER BY avg DESC;

--7 Find the name, price, and rating of the most expensive app with a 
...
SELECT app_name, reviews, min_install/reviews AS PROPORTION 
FROM analytics
